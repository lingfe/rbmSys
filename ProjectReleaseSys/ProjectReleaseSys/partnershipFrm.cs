...
namespace ProjectReleaseSys
{
    ...
    /// 合伙创业
    /// </summary>
    public partial class partnershipFrm : Form
    {
        /// <summary>
        /// 合伙创业的构造函数
        /// </summary>
        public partnershipFrm()
        {
            InitializeComponent();
        }
        /// <summary>
        ...
        /// </summary>
        forMian mian=null;
        public partnershipFrm(forMian mian)
        {
            InitializeComponent();
            this.mian = mian;
        }
        ...
        /// </summary>
        string update = null;
        public partnershipFrm(string update, string id, forMian mian)
        {
            this.update = update;
            this.id = id;
            this.mian = mian;
        ...
        /// </summary>
        string id = null;
        public partnershipFrm(string id, forMian mian)
        {
            this.id = id;
            this.mian = mian;
            InitializeComponent();
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void partnershipFrm_Load(object sender, EventArgs e)
        {
